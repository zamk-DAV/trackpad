...
[**Flicklane 0.1.6 Beta 1 다운로드 (.zip)**](https://github.com/zamk-DAV/trackpad/releases/download/v0.1.6-beta.1/Flicklane-0.1.6-25-universal.zip) · **빌드 25 · Apple silicon + Intel**
...
[0.1.6 Beta 1 전체 변경 내역과 검증 결과](docs/releases/0.1.6-beta.1.md)
...
| [마우스 감도 조절](docs/usage.md#마우스-감도-조절) | 마우스·트랙패드별 스크롤 방향과 외장 장치 자동 반전을 설정합니다. 포인터 속도·가속은 적용 가능한 장치에서 조절합니다. |
